...
import { FoodItemApiService } from 'src/app/foodItemApi.service';
...
export class FoodMenuComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private route: Router, private http: HttpClient, private foodService: FoodItemService, private cartService: CartService) {
